...
class ScheduleSecurityConfigTest {
    ...
    @Test
    void 블랙리스트_토큰은_401을_반환한다() throws Exception {
    ...
    @Test
    void 잘못된_토큰은_401을_반환한다() throws Exception {
    ...
    @Import({ SecurityConfig.class, ScheduleController.class, RestAuthenticationEntryPoint.class,
