...
## 3. 변경 예정 파일 목록
- `src/main/java/com/moneylog_backend/global/exception/GlobalExceptionHandler.java`
- `docs/workLog/WORKLOG_2026-02-15.md`
- `docs/changeLog/CHANGELOG_2026-02-15.md`
...
- 정리 대상: `docs/changeLog/CHANGELOG_2026-02-13.md`, `docs/changeLog/CHANGELOG_2026-02-14.md`, `docs/changeLog/CHANGELOG_2026-02-15.md`

## [MIGRATION] 기존 CHANGELOG 상세 이력 스냅샷 보존
- 아래 블록은 `docs/changeLog/CHANGELOG_2026-02-15.md` 정리 전 상세 원문 스냅샷입니다.
...
### 수행 내용
- `docs/workLog/WORKLOG_2026-02-13.md` 신규 생성
  - 기존 `docs/changeLog/CHANGELOG_2026-02-13.md` 상세 원문 전체 이관
- `docs/workLog/WORKLOG_2026-02-14.md` 신규 생성
  - 기존 `docs/changeLog/CHANGELOG_2026-02-14.md` 상세 원문 전체 이관
- `docs/workLog/WORKLOG_2026-02-15.md` 보강
  - 정리 전 `docs/changeLog/CHANGELOG_2026-02-15.md` 상세 원문 스냅샷 이관
- `docs/changeLog/CHANGELOG_2026-02-13.md`, `docs/changeLog/CHANGELOG_2026-02-14.md`, `docs/changeLog/CHANGELOG_2026-02-15.md` 재작성
  - 상세 내용 제거
