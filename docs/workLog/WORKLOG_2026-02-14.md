...
- 아래 내용은 기존 `docs/changeLog/CHANGELOG_2026-02-14.md`의 상세 기록 원문을 보존하기 위해 이관한 것입니다.
...
- `docs/changeLog/CHANGELOG_2026-02-14.md` (계획/승인/수행/검증 기록)
...
- 관련 파일
  - `src/moneylog/src/components/ScheduleDialog.tsx`
  - `docs/changeLog/CHANGELOG_2026-02-14.md`
- 현재 로직 요약
