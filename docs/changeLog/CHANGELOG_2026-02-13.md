...
- 프로젝트 구조/핵심 지식 문서 정비 및 작업용 메모리 문서 체계 확립
- 프론트/백엔드 중복 로직 1·2차 중앙화 및 enum 조회 구조 개선
- 거래/예산/결제수단 도메인에서 ownership 검증 보강(IDOR 위험 완화)
- 결제수단-계좌 연동 UX 및 데이터 정합성 개선(현금/계좌 선택, stale 값 정리)
